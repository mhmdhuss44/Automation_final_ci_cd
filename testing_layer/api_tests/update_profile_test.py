...
from Utilities import get_random_town
...
class profileTests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.cityChosen=get_random_town()
        self.profile_logic = update_profile(self.my_api,self.my_api.url,self.cityChosen)
    ...
    def test_check_town_in_profile(self):
        ...
        if city.lower() == self.cityChosen.lower():
            result=True
        else:
            result=False
        assert  result==True , "town wasnt changed to ..."
